...
public class KunaiBlindingEnchantment extends Enchantment {
    public KunaiBlindingEnchantment(Rarity pRarity, EnchantmentCategory pCategory, EquipmentSlot... pApplicableSlots) {
