...
public class KunaiGravityPullEnchantment extends Enchantment {
    public KunaiGravityPullEnchantment(Rarity pRarity, EnchantmentCategory pCategory, EquipmentSlot... pApplicableSlots) {
    ...
    protected boolean checkCompatibility(Enchantment pOther) {
        ...
        else if(pOther instanceof KunaiTeleportationEnchantment){
            return false;
        }
